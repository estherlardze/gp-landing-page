...
const ServiceCard = ({icon, title, text}) => {
  return (
    <div className='w-full sm:w-[350px] h-[320px] p-4 shadow-md hover:shadow-2xl flex flex-col items-center justify-center transition-all ease-in-out duration-500'>
