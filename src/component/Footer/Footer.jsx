...
const Footer = () => {
  ...
  const sectionStyle = "bg-black/90 text-white px-4 sm:px-8 xl:px-24 pt-8 pb-4 border-b border-gray-800 flex gap-8 grid grid-cols-9 "
  ...
  return (
    <footer className='mt-12'>
       <section className={sectionStyle}>
          ...
          <article className='col-span-9 sm:col-span-5 lg:col-span-2'>
          ...
          <article className='col-span-9 sm:col-span-4 lg:col-span-2'>
          ...
          <article className='col-span-9 sm:col-span-4 lg:col-span-3'>
       ...
       <article className='bg-black/100 text-white py-8 text-center'>
