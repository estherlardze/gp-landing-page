...
const TeamCard = ({image, name, position}) => {
  return (
   <div class="flex flex-col bg-white shadow-sm rounded-xl w-full sm:w-[265px] dark:shadow-slate-300 relative group ">
     <div>
       <img class="w-full sm:w-[280px] h-auto rounded-t-xl" src={image} alt="Team mate"/>
    ...
    <div class="p-4 md:p-5">
      ...
      <p class="mt-1 text-gray-800 dark:text-gray-400">{position}</p>
    </div>
</div>
  )    
}
